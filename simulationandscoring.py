...
def CheckConstraints(outputResult, constraintDict):
	...
	# Check for the constraints on the initial conditions of the state variables
    if 'varsIniBoundList' in constraintDict.keys():
        ...
        gIni = [True]
	# Check for the constraints on the time course of state variables 
    if 'varsBoundList' in constraintDict.keys():
        ...
        gResult = [True]
	# Check for the constraints on the state variables simulating toward equilibrium before the perturbation
